...
void ResetSpecialEncounters(void)
{
    ...
    FlagClear(FLAG_SPECIAL_ENCOUNTER_MAGMA_HIDEOUT_COMPLETE);
    FlagClear(FLAG_SPECIAL_ENCOUNTER_PETALBURG_CITY_COMPLETE);
    FlagClear(FLAG_SPECIAL_ENCOUNTER_DEWFORD_TOWN_COMPLETE);
}

void ResetMysteryNPC(void)
{
    FlagSet(FLAG_LILYCOVE_MYSTERY_NPC_HIDE);
    FlagClear(FLAG_LETTER_1_DECODED);
    FlagClear(FLAG_LETTER_1_GIVEN_TO_BE_DECODED);
    ...
    VarSet(VAR_MYSTIC_TICKET_STATE_BRENDAN, 0);
    VarSet(VAR_MYSTIC_TICKET_STATE_MAY, 0);
}
