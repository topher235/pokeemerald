...
{
    // if we're already at the last page,
    // don't allow the player to go to a non-existent next page
...
{
    // if we're already at the first page,
    // don't allow the player to go to a non-existent previous page
